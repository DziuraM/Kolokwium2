...
namespace Kolokwium2API.Migrations
{
    /// <inheritdoc />
    public partial class Init : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[,]
                {
                    { 1, "Anna", new DateTime(2020, 5, 15, 0, 0, 0, 0, DateTimeKind.Unspecified), "Nowak" },
                    { 2, "Jan", new DateTime(2018, 9, 10, 0, 0, 0, 0, DateTimeKind.Unspecified), "Kowalski" }
                });

            migrationBuilder.InsertData(
                table: "Nurseries",
                columns: new[] { "NurseryId", "EstablishedDate", "Name" },
                values: new object[] { 1, new DateTime(2010, 1, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), "GreenGrow" });
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, 1, 1000, new DateTime(2029, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), new DateTime(2024, 3, 1, 0, 0, 0, 0, DateTimeKind.Unspecified), 1 });
